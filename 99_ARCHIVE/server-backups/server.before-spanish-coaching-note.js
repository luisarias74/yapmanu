  ...
  const inputGuide = {
    ...
    phrase: isSentenceLike
      ? 'The learner typed a sentence or phrase that may have grammar errors. ' +
        ...
        'In the "note" field: if the sentence had an error, give ONE short correction rule (e.g. "Place \'very\' before the adjective"). ' +
        'If the sentence was already correct, set "note" to "That sounds natural."'
